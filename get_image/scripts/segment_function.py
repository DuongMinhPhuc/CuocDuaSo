...
def load_model_segmentation():
    CLASSES = open('/home/phucxo/catkin_ws/src/get_image/scripts/enet-cityscapes/enet-classes.txt').read().strip().split("\n")
    COLORS = open('/home/phucxo/catkin_ws/src/get_image/scripts/enet-cityscapes/enet-color-black.txt').read().strip().split("\n")
    ...
    net = cv2.dnn.readNet('/home/phucxo/catkin_ws/src/get_image/scripts/enet-cityscapes/enet-model.net')
    # print("load model segment success")
    return net, COLORS
