...
def callback_rgb(data):
	...
	if count % 10 == 0:
		#write real image
		#/home/phucxo/catkin_ws/src/get_data_image_angle/scripts/data/realImage
		cv2.imwrite('/home/phucxo/catkin_ws/src/get_data_image_angle/scripts/data/'+'realImage/'+str(count_image)+'.jpg', np.array(cv_image))
